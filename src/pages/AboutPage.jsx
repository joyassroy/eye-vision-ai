...
const team = [
  {
    ...
    contributions: [
      'Designed & trained the EfficientNet-V2-M model pipeline',
      'Built the FastAPI backend with Grad-CAM inference',
      'Implemented Bayesian Optimization via Optuna',
      'Developed the React frontend & UI/UX design',
    ],
  ...
  },
  {
    ...
    contributions: [
      'Conducted clinical dataset collection & preprocessing',
      'Implemented iterative stratified splitting pipeline',
      'Comparative benchmarking against ResNet50 & DenseNet121',
      'Documentation & research report authoring',
    ],
